...
class Kabupaten extends MY_Controller 
{
	...
	public function __construct()
	{
		...
		$this->data['subtitle'] = "(Pengolahan Data Kabupaten)";
		$this->data['index'] = "kabupaten";
		$this->data['field'] = array(
			...
			array('id'=>'provinsi','name'=>'Provinsi','type'=>'dropdown','size'=>15,'width'=>15,'table'=>false,'filter'=>true,'field'=>true,'rules'=>'required|trim'),
			array('id'=>'provinsi_name','name'=>'Provinsi','type'=>'string','size'=>100,'width'=>100,'table'=>true,'filter'=>false,'field'=>false,'rules'=>false)
		);
	}
