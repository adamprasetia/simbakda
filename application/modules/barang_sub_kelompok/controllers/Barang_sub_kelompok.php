...
class Barang_sub_kelompok extends MY_Controller 
{
	private $data = array();
	...
	{
		parent::__construct();
		$this->data['title'] = "Sub Kelompok Barang";
		$this->data['index'] = "barang_sub_kelompok";
		$this->data['title_parent'] = "Kelompok Barang";
		$this->data['index_parent'] = "barang_kelompok";
	...
	public function index()
	{
		...
		$this->data['code_parent'] = $this->data['code_parent'];
