...
{
	private $title = "Sub Kelompok Barang";
	private $index = "barang_sub_kelompok";
	private $title_parent = "Kelompok Barang";
	private $index_parent = "barang_kelompok";
	private $code_parent = "03";
