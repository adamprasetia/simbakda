	...
	<div class="box box-default">
		<div class="box-body">
			<?php echo form_open($action,array('class'=>'form-inline'))?>
				...
				<div class="form-group">
					<?php echo form_dropdown($index_parent,$this->general_model->dropdown('barang',$title_parent,array('type'=>$code_parent)),$this->input->get($index_parent),'class="form-control input-sm" onchange="submit()"')?>
				</div>
			<?php echo form_close()?>
