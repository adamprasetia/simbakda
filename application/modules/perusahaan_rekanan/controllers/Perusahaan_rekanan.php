...
class Perusahaan_rekanan extends MY_Controller 
{
	...
	{
		parent::__construct();
		$this->data['title'] = "Perusahaan Rekanan";
		$this->data['subtitle'] = "(Pengolahan Data Perusahaan Rekanan)";
		$this->data['index'] = "perusahaan_rekanan";
		$this->data['field'] = array(
			...
			array('id'=>'perusahaan_bentuk','name'=>'Bentuk','type'=>'dropdown','size'=>15,'width'=>15,'table'=>false,'filter'=>true,'field'=>true,'rules'=>'required|trim'),
			array('id'=>'perusahaan_bentuk_name','name'=>'Bentuk','type'=>'string','size'=>100,'width'=>100,'table'=>true,'filter'=>false,'field'=>false,'rules'=>false),
			array('id'=>'alamat','name'=>'Alamat','type'=>'memo','size'=>100,'width'=>50,'table'=>false,'filter'=>true,'field'=>true,'rules'=>'required|trim'),
			array('id'=>'pimpinan','name'=>'Pimpinan','type'=>'string','size'=>50,'width'=>50,'table'=>false,'filter'=>false,'field'=>true,'rules'=>'required|trim'),
			array('id'=>'bank','name'=>'Bank','type'=>'dropdown','size'=>15,'width'=>15,'table'=>false,'filter'=>true,'field'=>true,'rules'=>'required|trim'),
			array('id'=>'rekening','name'=>'Rekening','type'=>'string','size'=>50,'width'=>50,'table'=>false,'filter'=>false,'field'=>true,'rules'=>'required|trim'),
		);
	}
