...
class Barang_bidang extends MY_Controller 
{
	private $data = array();
	...
	{
		parent::__construct();
		$this->data['title'] = "Bidang Barang";
		$this->data['index'] = "barang_bidang";
		$this->data['title_parent'] = "Golongan Barang";
		$this->data['index_parent'] = "barang_golongan";
