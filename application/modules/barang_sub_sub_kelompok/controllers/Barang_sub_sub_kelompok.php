...
class Barang_sub_sub_kelompok extends MY_Controller 
{
	...
	{
		parent::__construct();
		$this->data['title'] = "Sub2 Kelompok Barang";
		$this->data['index'] = "barang_sub_sub_kelompok";
		$this->data['title_parent'] = "Sub Kelompok Barang";
		$this->data['index_parent'] = "barang_sub_kelompok";
		$this->data['code_parent'] = "04";
