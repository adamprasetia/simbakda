	...
	<div class="box box-default">
		...
		<div class="box-body">
			<div class="form-group form-inline">
				...
				<?php echo form_dropdown($index_parent,$this->general_model->dropdown('barang',$title_parent,array('type'=>$code_parent)),set_value('barang_golongan',(isset($row->parent)?$row->parent:'')),'required=required class="form-control input-sm select2"')?>
				<small><?php echo form_error($index_parent)?></small>
			</div>			
			<div class="form-group form-inline">
				<?php echo form_label($title,'code',array('class'=>'control-label'))?>
				<?php echo form_input(array('name'=>'code','class'=>'form-control input-sm','maxlength'=>'10','autocomplete'=>'off','value'=>set_value('code',(isset($row->code)?$row->code:'')),'required'=>'required','autofocus'=>'autofocus'))?>
				<small><?php echo form_error('code')?></small>
			</div>
			<div class="form-group form-inline">
				<?php echo form_label('Uraian','name',array('class'=>'control-label'))?>
