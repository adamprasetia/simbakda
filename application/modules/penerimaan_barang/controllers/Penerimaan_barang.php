...
class Penerimaan_barang extends MY_Controller 
{
	...
	public function __construct()
	{
		...
		$this->data['index'] = "penerimaan_barang";
	...
	public function index()
	{
		...
		$head_data = array(
			'nomor_ba_penerimaan' => 'Nomor BA Penerimaan',
		...
		foreach($result as $r){
			$this->table->add_row(
				...
				$i++,
				anchor($this->data['index'].'/edit/'.$r->id.get_query_string(),$r->nomor_ba_penerimaan),
				format_dmy($r->tanggal_terima),
	...
	private function _field(){
		$data = array(
			...
			'tanggal_terima' => format_ymd($this->input->post('tanggal_terima')),
			'nomor_dokumen' => $this->input->post('nomor_dokumen'),
			'nomor_ba_pemeriksaan' => $this->input->post('nomor_ba_pemeriksaan'),
			'tanggal_pemeriksaan' => format_ymd($this->input->post('tanggal_pemeriksaan')),
			'tahun_anggaran' => $this->input->post('tahun_anggaran'),
			'nomor_faktur' => $this->input->post('nomor_faktur'),
			'tanggal_faktur' => format_ymd($this->input->post('tanggal_faktur')),
			'bidang_unit' => $this->input->post('bidang_unit'),
			'dikirim_oleh' => $this->input->post('dikirim_oleh'),
	...
	private function _set_rules(){
		$this->form_validation->set_rules('nomor_ba_penerimaan','Nomor BA Penerimaan','required|trim');
