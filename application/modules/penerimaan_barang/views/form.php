			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group form-inline">
						<?php echo form_label('No BA Penerimaan','nomor_ba_penerimaan',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'nomor_ba_penerimaan','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('nomor_ba_penerimaan',(isset($row->nomor_ba_penerimaan)?$row->nomor_ba_penerimaan:'')),'required'=>'required','autofocus'=>'autofocus'))?>
						<small><?php echo form_error('nomor_ba_penerimaan')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('Tanggal Terima','tanggal_terima',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'tanggal_terima','class'=>'form-control input-sm input-tanggal','maxlength'=>'10','autocomplete'=>'off','value'=>set_value('tanggal_terima',(isset($row->tanggal_terima)?$row->tanggal_terima:'')),'required'=>'required'))?>
						<small><?php echo form_error('tanggal_terima')?></small>
					</div>					
					<div class="form-group form-inline">
						<?php echo form_label('No Dokumen','nomor_dokumen',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'nomor_dokumen','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('nomor_dokumen',(isset($row->nomor_dokumen)?$row->nomor_dokumen:''))))?>
						<small><?php echo form_error('nomor_dokumen')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('No BA pemeriksaan','nomor_ba_pemeriksaan',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'nomor_ba_pemeriksaan','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('nomor_ba_pemeriksaan',(isset($row->nomor_ba_pemeriksaan)?$row->nomor_ba_pemeriksaan:''))))?>
						<small><?php echo form_error('nomor_ba_pemeriksaan')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('Tanggal Pemeriksaan','tanggal_pemeriksaan',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'tanggal_pemeriksaan','class'=>'form-control input-sm input-tanggal','maxlength'=>'10','autocomplete'=>'off','value'=>set_value('tanggal_pemeriksaan',(isset($row->tanggal_pemeriksaan)?$row->tanggal_pemeriksaan:''))))?>
						<small><?php echo form_error('tanggal_pemeriksaan')?></small>
					</div>					
					<div class="form-group form-inline">
						<?php echo form_label('No Faktur','nomor_faktur',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'nomor_faktur','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('nomor_faktur',(isset($row->nomor_faktur)?$row->nomor_faktur:''))))?>
						<small><?php echo form_error('nomor_faktur')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('Tanggal Faktur','tanggal_faktur',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'tanggal_faktur','class'=>'form-control input-sm input-tanggal','maxlength'=>'10','autocomplete'=>'off','value'=>set_value('tanggal_faktur',(isset($row->tanggal_faktur)?$row->tanggal_faktur:''))))?>
						<small><?php echo form_error('tanggal_faktur')?></small>
					</div>					
				</div>
				<div class="col-md-6">
					<div class="form-group form-inline">
						<?php echo form_label('Tahun Anggaran','tahun_anggaran',array('class'=>'control-label'))?>
						<?php echo form_dropdown('tahun_anggaran',$this->general_model->dropdown('tahun_anggaran','Tahun Anggaran'),set_value('tahun_anggaran',(isset($row->tahun_anggaran)?$row->tahun_anggaran:'')),'class="form-control input-sm select2"')?>
					...
					<div class="form-group form-inline">
					 	<?php echo form_label('Dikirim Oleh','dikirim_oleh',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'dikirim_oleh','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('dikirim_oleh',(isset($row->dikirim_oleh)?$row->dikirim_oleh:''))))?>
						<small><?php echo form_error('dikirim_oleh')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('Diterima Oleh','diterima_oleh',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'diterima_oleh','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('diterima_oleh',(isset($row->diterima_oleh)?$row->diterima_oleh:''))))?>
						<small><?php echo form_error('diterima_oleh')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('Keterangan','ket',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'ket','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('ket',(isset($row->ket)?$row->ket:''))))?>
