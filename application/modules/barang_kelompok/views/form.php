	...
	<div class="box box-default">
		...
		<div class="box-body">
			<div class="form-group form-inline">
				...
				<?php echo form_dropdown($index_parent,$this->general_model->dropdown('barang',$title_parent,array('type'=>$code_parent)),set_value('barang_golongan',(isset($row->parent)?$row->parent:'')),'required=required class="form-control input-sm"')?>
