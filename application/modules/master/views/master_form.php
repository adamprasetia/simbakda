	...
	<div class="box box-default">
		...
		<div class="box-body">
			<div class="form-group form-inline">
				...
				<?php echo form_input(array('name'=>'code','class'=>'form-control input-sm','maxlength'=>'10','size'=>'10','autocomplete'=>'off','value'=>set_value('code',(isset($row->code)?$row->code:'')),'required'=>'required'))?>
