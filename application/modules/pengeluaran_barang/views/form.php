			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group form-inline">
						<?php echo form_label('No BA Pengeluaran','nomor_ba_pengeluaran',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'nomor_ba_pengeluaran','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('nomor_ba_pengeluaran',(isset($row->nomor_ba_pengeluaran)?$row->nomor_ba_pengeluaran:'')),'required'=>'required','autofocus'=>'autofocus'))?>
						<small><?php echo form_error('nomor_ba_pengeluaran')?></small>
					</div>
					<div class="form-group form-inline">
						<?php echo form_label('Tanggal Keluar','tanggal_keluar',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'tanggal_keluar','class'=>'form-control input-sm input-tanggal','maxlength'=>'10','autocomplete'=>'off','value'=>set_value('tanggal_keluar',(isset($row->tanggal_keluar)?$row->tanggal_keluar:'')),'required'=>'required'))?>
						<small><?php echo form_error('tanggal_keluar')?></small>
					</div>					
					<div class="form-group form-inline">
						<?php echo form_label('No BA penerimaan','nomor_ba_penerimaan',array('class'=>'control-label'))?>
						<?php echo form_input(array('name'=>'nomor_ba_penerimaan','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('nomor_ba_penerimaan',(isset($row->nomor_ba_penerimaan)?$row->nomor_ba_penerimaan:''))))?>
				...
				<div class="col-md-6">
					...
					<div class="form-group form-inline">
						...
						<?php echo form_input(array('name'=>'kepada','class'=>'form-control input-sm','maxlength'=>'100','size'=>'50','autocomplete'=>'off','value'=>set_value('kepada',(isset($row->kepada)?$row->kepada:''))))?>
						<small><?php echo form_error('kepada')?></small>
					</div>
				</div>
			</div>
		</div>
