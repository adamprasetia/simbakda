...
class Bidang_unit_kerja extends MY_Controller 
{
	...
	public function __construct()
	{
		...
		$this->data['subtitle'] = "(Pengolahan Data Unit Kerja)";
		...
		$this->data['field'] = array(
			...
			array('id'=>'bidang_unit','name'=>'Unit Bidang','type'=>'dropdown','size'=>15,'width'=>15,'table'=>false,'filter'=>true,'field'=>true,'rules'=>'required|trim'),
			array('id'=>'bidang_unit_name','name'=>'Unit Bidang','type'=>'string','size'=>100,'width'=>100,'table'=>true,'filter'=>false,'field'=>false,'rules'=>false)
		);
	}
