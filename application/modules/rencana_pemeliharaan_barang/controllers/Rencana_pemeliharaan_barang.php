...
class Rencana_pemeliharaan_barang extends MY_Controller 
{
	private $data = array();
	...
	{
		parent::__construct();
		$this->data['title'] = "Rencana Pemeliharaan Barang";
		$this->data['subtitle'] = "(Pengolahan Data Rencana Pemeliharaan Barang)";
		$this->data['index'] = "rencana_pemeliharaan_barang";
