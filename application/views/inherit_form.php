		...
		<div class="box-body">
			<?php if (isset($index_parent) && isset($tbl_name) && $index_parent==$tbl_name): ?>
				<div class="form-group form-inline">
					...
					<?php echo form_dropdown($index_parent,$this->general_model->dropdown($index_parent,$title_parent,array('type'=>$code_parent)),set_value($index_parent,(isset($row->parent)?$row->parent:'')),'required=required class="form-control input-sm select2"')?>
			...
			<div class="form-group form-inline">
				...
				<?php echo form_input(array('name'=>'code','class'=>'form-control input-sm','maxlength'=>'15','autocomplete'=>'off','value'=>set_value('code',(isset($row->code)?$row->code:'')),'required'=>'required'))?>
